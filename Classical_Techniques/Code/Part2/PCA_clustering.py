...
print("Training Using PCA features")
for n_clusters_per_class in n_clusters_list:
    ...
    for digit in range(10):
        ...
        digit_features = pca_train[y_train == digit]
...
for i, result in enumerate(results):
    ...
    plt.title(f'Confusion Matrix (PCA, K-means with {result["n_clusters"]} clusters)\nAccuracy: {result["accuracy"]:.2f}%')

plt.tight_layout()
plt.savefig('confusion_matrices_pca_kmeans_all.png')
plt.show()
